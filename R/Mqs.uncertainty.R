...
#' end-member loadings.
#' @param lw Numeric vector with the weight tranformation limits (i.e.
#' quantiles after Klovan & Imbrie, 1971). If the parameter is of length 1,
#' \code{lw} is assumed to be a constant, if of length 2, \code{lw} defines
...
#' @param type.lw Character scalar with type of random lw value generation.
...
#' @return A list with numeric vector and matrix objects. \item{lw}{Randomised
